  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        <h1 className="text-3xl font-bold p-5 text-gray-600">Your Recent Tickets</h1>
      ...
      {issues.length > 0 ? (
        <div className="overflow-hidden rounded-3xl border border-gray-200 dark:border-dark-border-default bg-white dark:bg-dark-high shadow-sm">
          {/* Header row */}
