...
export default function FAQPage() {
  return (
    <div className="container mx-auto px-4 py-12 text-white">
      <h2 className="text-2xl font-bold mb-8 text-center text-black/85">
...
function FAQItem({ question, answer }: FAQItemProps) {
  return (
    <div>
      <h4 className="text-xl font-semibold mb-2 text-black/75">{question}</h4>
      <p className="text-gray-500 dark:text-gray-500">{answer}</p>
    </div>
  )
}
